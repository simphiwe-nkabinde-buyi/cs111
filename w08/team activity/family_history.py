...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        print(f"{value[NAME_INDEX]} {value[DEATH_YEAR_INDEX]}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        husband_value = people_dict[value[HUSBAND_KEY_INDEX]]
        wife_value = people_dict[value[WIFE_KEY_INDEX]]

        wedding_year = value[WEDDING_YEAR_INDEX]
        husband_name = husband_value[NAME_INDEX]
        husband_wedding_age = wedding_year - husband_value[BIRTH_YEAR_INDEX]
        wife_name = wife_value[NAME_INDEX]
        wife_wedding_age = wedding_year - wife_value[BIRTH_YEAR_INDEX]

        print(f"{husband_name} {husband_wedding_age} > {wedding_year} < {wife_name} {wife_wedding_age}")
