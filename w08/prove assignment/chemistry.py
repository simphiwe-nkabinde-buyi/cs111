...
def main():
    ...
    chem_formula = input("Enter the molecular formula of the sample: ")

    # Get the mass of a chemical sample in grams from the user.
    mass = input("Enter the mass in grams of the sample:")

    # Call the make_periodic_table function andC13H18O2
    ...
    number_of_moles = float(mass) / molar_mass

    # Print the molar mass.
    print(f"{molar_mass:5f} grmas/mole")
...
def make_periodic_table():
    """creates and returns a compound list from a periodic table
    """
    return {
